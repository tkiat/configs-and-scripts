...
// 					 "entry is highlighted."),
      msg_translated = grub_xasprintf (_("The available keys are %C, %C, enter, 'e', and 'c'. \
Figure out yourself what they do lol."),
	...
	return 0;
      ...
      ret += grub_print_message_indented_real
        (_("By the way, if I lost this laptop you can contact me via"),
         STANDARD_MARGIN, STANDARD_MARGIN, term, dry_run);

      ret += grub_print_message_indented_real
        (_("tkiat@tutanota.com or (+66)646468180. Thanks!"),
         STANDARD_MARGIN, STANDARD_MARGIN, term, dry_run);
